...
local Window = Rayfield:CreateWindow({
   Name = "AHMED67 GUI V1.0.0",
   Icon = 0, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
   LoadingTitle = "AHMED67 GUI V1.0.0",
   LoadingSubtitle = "by Ahmed",
...
local function createESPElements()
	...
	return {
		...
		Name = name,
		Tracer = tracer,
		HealthBG = healthBG,		HealthFG = healthFG
	}
end
...
local Button = Tab:CreateButton({
   Name = "99 NIGHTS KEYLESS",
   Callback = function()
   loadstring(game:HttpGet("https://rawscripts.net/raw/99-Nights-in-the-Forest-99-nights-keyless-tp-all-loot-70494"))()
   end,
})

local Section = Tab:CreateSection("STEAL A BRAINROT")

local Button = Tab:CreateButton({
   Name = "MOLYN DEVELOPMENT (NOT WORKING)",
   Callback = function()
...
local Section = Tab:CreateSection("PLANTS VS BRAINROTS")
...
local Paragraph = Tab:CreateParagraph({Title = "Credits", Content = "sirius.menu for rayfield ui and ahmed67ak47 for making this script"})
